    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data && res.data.length > 0) {
          ...
          const DeployedTasks = res.data.filter(
            (task) => task.status == "Deployed"
          );
          setTimeout(() => {
            if (DeployedTasks != undefined && DeployedTasks.length > 0) {
              console.log("_____aya ", [...DeployedTasks]);
              setCardContent(DeployedTasks);
            }
            console.log("_____end ", DeployedTasks);
          }, 0);
        }
      })
      .catch((err) => {
